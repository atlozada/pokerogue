...
export class PostSummonPhase extends PokemonPhase {
  ...
  start() {
    ...
    console.log("Applying ArenaTagAbAttr")
    applyArenaTagAbAttrs(ArenaTagAbAttr, pokemon, new Utils.BooleanHolder(false), this.scene.arena);
